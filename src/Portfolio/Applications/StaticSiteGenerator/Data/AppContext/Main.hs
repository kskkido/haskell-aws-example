module Portfolio.Applications.StaticSiteGenerator.Data.AppContext.Main
  ( AppContext(..)
  , fromConfig
  , toPageContext
  ) where
...
import qualified Portfolio.Services.Contentful.Data.Service.Main as Contentful.Service
...
data AppContext = AppContext
  ...
  , contentfulService :: Contentful.Service.Service
  }
...
fromConfig config locale = do
  ...
  pure $ AppContext
    ...
    , contentfulService = Contentful.Service.fromContentful $ Contentful.Config.Config
