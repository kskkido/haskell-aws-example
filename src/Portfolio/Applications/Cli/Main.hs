...
import qualified Portfolio.Applications.DeploymentStack.Main as DeploymentStack
import qualified Portfolio.Applications.ApplicationStack.Main as ApplicationStack
...
main = do
  ...
  case cliInput of
    ...
    CliInput.CliDeploymentStackInput -> do
      DeploymentStack.main
    CliInput.CliApplicationStackInput -> do
