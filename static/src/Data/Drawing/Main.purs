module Data.Drawing.Main where
...
fromWindow :: Web.HTML.Window.Window -> Effect.Effect (Array Drawing)
...
fromParentNode :: Web.DOM.ParentNode.ParentNode -> Effect.Effect (Array Drawing)
...
fromNodeList :: Web.DOM.NodeList.NodeList -> Effect.Effect (Array Drawing)
...
fromElement :: Web.DOM.Element.Element -> Effect.Effect (Maybe.Maybe Drawing)
